...
def get_args_parser():
    ...
    # Required parameters
    parser.add_argument("--data_dir", default="../data/retacred", type=str, required=False,
    ...
    parser.add_argument("--model_name_or_path", default="deepset/roberta-base-squad2", type=str, required=False,
    ...
    parser.add_argument("--cache_dir", default="../Output", type=str,
